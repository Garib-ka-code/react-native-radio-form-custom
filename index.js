...
class RadioForm extends Component {
    ...
    renderRadioItem(item, i) {
        ...
        return (
            ...
            >
                <View
                    style={ this.props.customViewStyle }
                >
                    {this.renderRadioCircle(isSelected)}
                    <View
                        style={{ marginLeft: 3 }}
                    >
                        <Text style={ this.props.customTextStyle }>{'' + item[itemShowKey]}</Text>
                    </View>
                </View>
            </TouchableWithoutFeedback>
        );
    ...
    renderRadioCircle(isSelected) {
        ...
        return (
            <View
                style={{ width: outerSize, height: outerSize, margin: 10, justifyContent: 'center', alignItems: 'center',
                    borderRadius: outerSize / 2, borderWidth: 1, borderColor: this.props.outerColor }}
            >
                <View
